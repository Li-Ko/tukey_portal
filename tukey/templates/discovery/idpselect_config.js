...
function IdPSelectUIParms(){
    ...
    this.dataSource = 'disco.json';    // Where to get the data from 
    this.defaultLanguage = 'en';     // Language to use if the browser local doesnt have a bundle
    this.defaultLogo = 'flyingpiglogo.jpg';
    this.defaultLogoWidth = 90;
    this.defaultLogoHeight = 80 ;
    this.defaultReturn = "https://opensciencedatacloud.org/Shibboleth.sso/Login?target={{ next }}";
                                     // Approaching via the Discovery Protocol for example
    //this.defaultReturn = "https://opensciencedatacloud.org/Shibboleth.sso/DS?SAMLDS=1&target=https://opensciencedatacloud.org/secure";
    this.defaultReturnIDParam = null;
    this.helpURL = '/support';
    ...
    this.preferredIdP = ["urn:mace:incommon:uchicago.edu"];        // Array of entityIds to always show
